...
while True:
    ...
    if not find_coordinates_template_img_in_main_img(main_png, empty_enemy_heals_bar_fragment, 0.98):
        if not find_coordinates_template_img_in_main_img(main_png, full_enemy_heals_bar_fragment, 0.85):
            ...
            save_main_picture(determine_enemy, top=27, left=570, wight=8, height=8)
            if find_coordinates_template_img_in_main_img(determine_enemy, determine_enemy_fragment, 0.98):
                print(f'Fight _{iteration_number1}_ {datetime.datetime.today().strftime("%H:%M:%S")}')
                iteration_number1 += 1
                iteration_number2 = 1
                if find_coordinates_template_img_in_main_img(main_png, empty_enemy_heals_bar_fragment, 0.98):
                    break
                pyautogui.press('4')
