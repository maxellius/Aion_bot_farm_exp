...
while True:
    ...
    if not find_coordinates_template_img_in_main_img(main_png, empty_enemy_heals_bar_fragment, 0.98):
        ...
        if find_coordinates_template_img_in_main_img(heal_bar_png, heal_bar_fragment, 0.60) is None:
            time.sleep(0.5)
            pyautogui.press('0')
            while find_coordinates_template_img_in_main_img(heal_bar_png, heal_bar_fragment, 0.60) is None:
                save_main_picture(heal_bar_png, top=711, left=297, wight=141, height=10)
            else:
                time.sleep(0.5)
                pyautogui.press('0')
