...
while True:
    ...
    if not find_coordinates_template_img_in_main_img('main.png', '5.png', 0.98):
        if not find_coordinates_template_img_in_main_img('main.png', '7.png', 0.85):
            ...
            while find_coordinates_template_img_in_main_img('main.png', '5.png', 0.98) is None:
                if find_coordinates_template_img_in_main_img('main.png', '5.png', 0.98) is not None:
                    break
                pyautogui.press('5')
                if find_coordinates_template_img_in_main_img('main.png', '5.png', 0.98) is not None:
                    break
